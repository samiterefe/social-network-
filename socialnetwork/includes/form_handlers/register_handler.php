...
if(isset($_POST['register_btn'])){
	...
	$_SESSION['req_email2'] = $em2; //Stores email2 into session variable

	//Password
	$password = strip_tags($_POST['req_password']); //Remove html tags
	$password2 = strip_tags($_POST['req_password2']); //Remove html tags
	...
	if(empty($error_array)) {
		...
		$query = mysqli_query($conn, "INSERT INTO users VALUES ('', '$fname', '$lname', '$username', '$password', '$em', '$date', '$profile_pic', '0', '0', 'no', ',')");
